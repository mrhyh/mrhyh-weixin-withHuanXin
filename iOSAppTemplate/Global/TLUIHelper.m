...
{
    TLSettingItem *notify = [TLSettingItem createWithImageName:@"plugins_FriendNotify" title:@"申请与通知"];
    TLSettingItem *friendGroup = [TLSettingItem createWithImageName:@"add_friend_icon_addgroup" title:@"群组"];
    TLSettingItem *tag = [TLSettingItem createWithImageName:@"Contact_icon_ContactTag" title:@"聊天室"];
...
+ (NSMutableArray *) getMineDetailVCItems
{
    ...
    TLSettingItem *name = [TLSettingItem createWithTitle:@"名字" subTitle:username];
...
+ (NSMutableArray *) getSettingVCItems
{
    ...
    TLSettingItem *exit = [TLSettingItem createWithTitle:@"退出登录"];
