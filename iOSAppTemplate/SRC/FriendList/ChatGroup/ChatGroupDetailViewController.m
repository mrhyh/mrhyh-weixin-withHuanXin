...
- (void)dissolveAction; //解散群组
- (void)clearAction; ////清空聊天记录
- (void)exitAction; //退出群组
- (void)configureAction; //设置群组
...
- (void)fetchGroupInfo
{
    ...
    [[EaseMob sharedInstance].chatManager asyncFetchGroupInfo:groudId  completion:^(EMGroup *group, EMError *error) {
